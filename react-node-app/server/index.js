...
app.post("/verifyAcc", customerController.verifyAcc)
...
app.post("/getUserPromoStatus", verifyJWT, customerController.getUserPromoStatus)
app.post("/setUserPromoStatus", verifyJWT, customerController.setUserPromoStatus)
...
app.post("/sendVehicle", adminController.sendVehicle)
